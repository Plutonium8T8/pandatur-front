    ...
    return (
        <Card withBorder radius="lg" p="lg" style={{ height: "100%", display: "flex", flexDirection: "column" }}>
            <Group justify="space-between">
                <Group gap="xs">
                    ...
                    <Badge variant="light" ml="xs">
                        {dateRange?.[0] ? format(dateRange[0], "dd.MM.yyyy") : "—"} → {dateRange?.[1] ? format(dateRange[1], "dd.MM.yyyy") : "—"}
                    </Badge>
                </Group>
            ...
            <Stack gap={8} style={{ overflow: "auto" }}>
                <Group justify="space-between">
                    <Text size="sm" c="green">Входящие</Text>
                ...
                <Group justify="space-between" style={{ marginTop: 6 }}>
                    <Text size="sm" c="blue">Исходящие</Text>
